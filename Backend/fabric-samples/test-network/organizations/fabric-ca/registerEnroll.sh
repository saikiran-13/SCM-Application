...
function createOrg1() {
  ...
  set -x
  fabric-ca-client enroll -u https://factory_admin:factory@123@localhost:7054 --caname ca-org1 --tls.certfiles "${PWD}/organizations/fabric-ca/org1/ca-cert.pem"
  { set +x; } 2>/dev/null
...
function createOrg2() {
  ...
  set -x
  fabric-ca-client enroll -u https://warehouse_admin:warehouse@123@localhost:8054 --caname ca-org2 --tls.certfiles "${PWD}/organizations/fabric-ca/org2/ca-cert.pem"
  { set +x; } 2>/dev/null
