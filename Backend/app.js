...
const qualityCheckRoute = require('./src/routes/qualityCheck')
...
const productHistoryRoute = require('./src/routes/productHistory')
...
app.use('/qualityCheck',jwtAuthorization,qualityCheckRoute)
app.use('/showProducts',jwtAuthorization,showProductsRoute)
app.use('/productHistory',jwtAuthorization,productHistoryRoute)
